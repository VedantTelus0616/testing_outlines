...
MUST return the concept you have picked from this Json for each question as a separate "Concept" keyword E.g  {"Concept" :"Inheritance"} , {"Concept" :"Binary Trees"} or {"Concept" :"Mobile Development"} ,{"Concept" :"Database Management"}.
